...
const Overview = () => {
  return (
    <div className="max-w-8xl mx-auto">
      <div className="flex h-[30rem] mx-auto mt-5">
        <div id="left" className="w-[50%] p-8 ml-24">
          ...
          <p className="text-2xl">
            ...
            success. RateMyProfessorIO goes beyond traditional professor
            ratings, providing you with tailored recommendations that align with
            your learning preferences and aspirations. Our intelligent algorithm
            analyzes your academic background, learning style, and desired
            outcomes to suggest professors who can effectively support your
            growth
          </p>
        </div>
        <div
